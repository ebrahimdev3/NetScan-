...
```bash
cd ~ && pip install -r ~/requirements.txt && (uvicorn NetScan.Web_Version.backend.main:app --host 0.0.0.0 --port 8000 --reload &) && cd ~/NetScan/Web_Version/frontend/ && python -m http.server 8080
